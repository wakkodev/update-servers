...
uninstall_server() {
    echo -e "\n\e[1;34mUninstalling UDP Hysteria server...\e[0m"
    ...
    echo -e "\e[1;32mUDP Hysteria server uninstalled successfully.\e[0m"
}

show_banner() {
    echo -e "\e[1;36m---------------------------------------------"
    echo " UDP Hysteria Manager"
    echo " (c) 2026 WakkoDev"
    echo " Telegram: @judabuac"
    echo "---------------------------------------------\e[0m"
}
